...
<head>
    ...
    <title>Praktikum CSS — Media Pembelajaran SMK</title>
    <!-- Font Google -->
...
<body class="bg-brand-900 text-slate-200 antialiased font-sans selection:bg-brand-accent selection:text-white h-screen overflow-hidden">
    ...
    <div class="h-full flex flex-col">
        ...
        <header class="h-14 flex items-center justify-between px-4 md:px-6 bg-red-800 text-white shadow-md border-b-4 border-red-700 z-10 shrink-0">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <h1 class="font-semibold text-base md:text-lg text-white ml-1">Praktikum CSS</h1>
            </div>
        ...
        <main class="flex-grow flex flex-col md:flex-row h-[calc(100vh-4rem)] overflow-hidden">
            ...
            <aside id="tutorial-sidebar" class="w-full md:w-[250px] flex-shrink-0 bg-brand-800 text-slate-200 overflow-y-auto hidden md:flex flex-col border-r border-brand-700 transition-all duration-300 ease-in-out">
                <div class="pt-5 pb-3 px-4 text-xl tracking-wide font-bold text-white border-b border-brand-700/50 mb-2">CSS Practice</div>
                <nav class="flex flex-col text-[15px] pb-6 flex-grow" id="sidebar-nav">
                    <a href="#" class="sidebar-item block px-4 py-2 hover:bg-brand-700 transition-colors" data-topic="CSS Introduction">CSS Introduction</a>
                    <a href="#" class="sidebar-item block px-4 py-2 hover:bg-brand-700 transition-colors" data-topic="Selectors & Properties">Selectors & Properties</a>
                    <a href="#" class="sidebar-item block px-4 py-2 hover:bg-brand-700 transition-colors" data-topic="Box Model">Box Model</a>
                    <a href="#" class="sidebar-item block px-4 py-2 hover:bg-brand-700 transition-colors" data-topic="Flexbox">Flexbox</a>
                </nav>
            </aside>
                ...
                <section class="w-full md:w-1/2 landscape:w-1/2 h-1/2 md:h-full landscape:h-full flex flex-col border-b md:border-b-0 landscape:border-b-0 md:border-r landscape:border-r border-brand-700 relative">
                    <div class="bg-brand-800 text-xs py-2 px-4 border-b border-brand-700 text-brand-accent font-mono flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <i class="fab fa-css3-alt text-blue-500 text-lg"></i> index.php
                        </div>
                    </div>
    ...
    <script>
        ...
        // Data Tutorial yang memetakan topik ke kode HTML/CSS
        const tutorialData = {
            'CSS Introduction': `<!DOCTYPE html>
<html lang="id">
<head>
...
<p>Ini adalah paragraf. Ubah warna pada CSS untuk melihat perubahannya.</p>

</body>
</html>`,
            'Selectors & Properties': `<!DOCTYPE html>
<html lang="id">
<head>
...
<p>Setiap paragraf akan berwarna merah (Element Selector).</p>
<p id="para1">Paragraf ini berwarna biru (ID Selector).</p>
<h1 class="center">Heading berwarna hijau (Class Selector)</h1>

</body>
</html>`,
            'Box Model': `<!DOCTYPE html>
<html lang="id">
<head>
...
<h2>Demonstrasi Box Model</h2>

<p>Box model CSS pada dasarnya adalah sebuah kotak yang membungkus setiap elemen HTML. Terdiri dari margin, border, padding, dan konten.</p>

<div>Teks ini adalah bagian konten dari box. Kita menambahkan padding 50px, border 15px, dan margin 20px. Cobalah untuk mengubah ukurannya!</div>
...
<h1>Dasar Flexbox</h1>
<p>Elemen container diberi properti "display: flex" untuk membuatnya fleksibel.</p>
...
<div class="flex-container">
  ...
  <div>3</div>  
        ...
        editor.setValue(tutorialData['CSS Introduction']);
